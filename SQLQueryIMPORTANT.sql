...
-- select MIN(Tarih) from #log WHERE Quantity <> 0 --Sipariþ sayýsý 0 olmayan ilk tarihi bulan komut
...
--select @siparisAdedi = count(*) from #log where Tip='C' --Customerden gelen sipariþlerin adedini  @siparisAdedi deðiþkenine atayan komut
...
--idx e göre döncem tipine bak sonra sonra adede bak karþýlýyor mu karþýlamýyor mu 
while @i <= 1000
begin
